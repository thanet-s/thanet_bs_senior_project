...
class Transaction(Base):
    ...
    id = Column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4, unique=True, index=True)
    account_number = Column(String(255), ForeignKey("accounts.account_number", ondelete="CASCADE"))
...
class Transfer(Base):
    ...
    destination_account_number = Column(String(255), ForeignKey("accounts.account_number", ondelete="CASCADE"))