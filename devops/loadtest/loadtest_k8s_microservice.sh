...
docker run --rm -v $(pwd)/devops:/devops -v $(pwd)/key:/key:ro -v $(pwd)/loadtest_result:/loadtest_result project-utils ansible-playbook loadtest/loadtest_k8s_microservice.yml -e "ansible_user=$ANSIBLE_USER"
